...
def get_argparse():
    ...
    # SpecAugment
    parser.add_argument('--use_specaugment', type=str2bool, default=False,
                        help='enable SpecAugment during training only')
    parser.add_argument('--specaug_time_mask_param', type=int, default=1,
                        help='maximum time mask width over the frame axis')
    parser.add_argument('--specaug_freq_mask_param', type=int, default=12,
                        help='maximum frequency mask width over the mel axis')
    parser.add_argument('--specaug_num_time_masks', type=int, default=1,
                        help='number of time masks to apply')
    parser.add_argument('--specaug_num_freq_masks', type=int, default=1,
                        help='number of frequency masks to apply')
    parser.add_argument('--specaug_prob', type=float, default=0.5,
                        help='probability of applying SpecAugment to a training batch')
