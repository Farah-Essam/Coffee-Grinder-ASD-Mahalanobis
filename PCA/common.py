...
def get_argparse():
    ...
    parser.add_argument('--score', type=str, default="MSE", choices=["MSE", "MAHALA", "MAHALA_PCA"])
    parser.add_argument('--mahala_pca_dim', type=int, default=32,
                        help='PCA subspace dimension for MAHALA_PCA scoring (default: 32)')
